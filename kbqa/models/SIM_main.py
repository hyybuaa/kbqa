...
def cal_acc(real_label,pred_label):
    ...
    # print("real_shape: ", real_label.shape[0])
...
# def cal_acc_multi(test_y, y_pred):
#     print("accuracy score: {:<8.5f}".format(metrics.accuracy_score(y_pred, test_y)))
#     print("f1 score: {:<8.5f}".format(metrics.f1_score(y_pred, test_y, average='micro')))
#     print("多分类结果: ")
...
def evaluate(args, model, eval_dataset):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            # logger.iinfo("样本个数：", total_sample_num)
    ...
    f1_score = metrics.f1_score(all_pred_label, all_real_label, average='micro')
    label_acc = metrics.accuracy_score(all_pred_label, all_real_label)
    print("accuracy score: {:<8.5f}".format(metrics.accuracy_score(all_pred_label, all_real_label)))
    print("f1 score: {:<8.5f}".format(metrics.f1_score(all_pred_label, all_real_label, average='micro')))
    print("多分类结果: ")
    print(metrics.classification_report(all_pred_label, all_real_label))

    # question_acc,label_acc = cal_acc(all_real_label,all_pred_label)

    model.train()
    return loss, f1_score, label_acc
