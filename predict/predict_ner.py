...
config_file = r'input/config/bert-base-chinese-config.json'
vocab_file = r'input/config/bert-base-chinese-vocab.txt'
ner_mode_path = r'output/best_ner.bin'
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
max_length = 128
...
def get_entity_keyword(query, top_k=3):
    pos = ['an', 'ns', 'n', 'nr', 'i', 'm', 'ng', 'nt', 'nz', 'vn']
